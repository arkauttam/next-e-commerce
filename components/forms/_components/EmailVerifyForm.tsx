...
const EmailVerifyForm: FC<Props> = () => {
  ...
  return (
    <Form {...form}>
      <form
        className=" max-w-md w-[max(90%,800px)]  bg-[#0f172a] text-gray-200 rounded-lg shadow-lg p-8 space-y-5"
        onSubmit={form.handleSubmit(
          step === "form" ? handleSubmitForm : handleVerifyOtp
        )}
      >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <div className="flex items-center gap-1 rounded-lg border border-gray-300 px-4 py-2 focus-within:ring-2 focus-within:ring-[#164880]">
                      <Image
                        src="/india-flag.svg"
                        alt="indian flag"
                        width={10}
