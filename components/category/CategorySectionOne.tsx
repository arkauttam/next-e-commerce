        ...
        {dummyCategories.map((category) => (
          ...
          >
            ...
            <div className="text-center">
              <p className="text-xl font-semibold hover:underline text-gray-600 dark:text-white">{category.name}</p>
              <p className="text-gray-500 dark:text-white">{category.description}</p>
            </div>
          </Card>
        ))}
      </div>
